    ...
    >
      ...
      <div
        ...
        className="pointer-events-none absolute top-0 left-1/2 -translate-x-1/2
          w-full max-w-[700px] h-px bg-gradient-to-r from-transparent via-secondary/25 to-transparent"
      />
      ...
      <div className="max-w-6xl mx-auto space-y-20 md:space-y-24">
        ...
        >
          ...
          >
            ...
            <br />
            <span
              className="bg-gradient-to-r from-primary via-secondary to-foreground/70
          ...
          >
            Two years in, I&apos;ve gone from intern to the person other devs
            ask when something needs to look right <em>and</em> perform right.
          </motion.p>
        </motion.div>
          ...
          >
            ...
            <div className="relative space-y-5">
              <p className="text-base md:text-lg text-foreground/75 leading-relaxed">
                ...
                who cares about the full chain — from design tokens to deploy
                pipelines. My focus is
                <span className="text-secondary font-semibold">
                  {" "}
                  React and Next.js
                </span>
                , but I&apos;m equally comfortable debugging a Node API or
                setting up a CI workflow.
              </p>
              <p className="text-base md:text-lg text-foreground/75 leading-relaxed">
                I&apos;ve shipped features used by thousands of real users, cut
                page-load times by over 60% on live products, and built
                component libraries that other developers actually want to use.
                I believe the best UIs are invisible — fast, accessible, and out
                of the user&apos;s way.
              </p>
              ...
              <div className="grid grid-cols-2 gap-3 pt-1">
                {[
                  ...
                  >
                    ...
                    <p
                      className={`text-sm font-semibold ${accent ? "text-primary/90" : "text-foreground"}`}
                    >
                      {value}
                    </p>
                  </div>
              ...
              <div className="flex items-center gap-3 p-4 rounded-2xl border border-green-500/20 bg-green-500/5">
                ...
                <div>
                  ...
                  <p className="text-xs text-foreground/40 mt-0.5">
                    Open to Frontend / Full-Stack roles · Remote or Bengaluru ·
                    IST (UTC+5:30)
                  </p>
                </div>
              </div>
          ...
          <motion.div variants={stagger} className="space-y-3">
            ...
            {focusAreas.map((area, i) => (
              <motion.div key={area.title} custom={i} variants={fadeUp}>
                <RevealCard className="p-4 border border-white/8 bg-white/[0.03] rounded-2xl">
          ...
          {stats.map((s, i) => (
            <motion.div key={s.label} custom={i} variants={fadeUp}>
              <RevealCard className="p-5 md:p-6 text-center border border-white/8 bg-white/[0.03]">
                ...
                />
                <p className="text-xs text-foreground/45 mt-1.5 font-medium">
                  {s.label}
                </p>
              </RevealCard>
            </motion.div>
                ...
                <RevealCard className="p-5 md:p-6 border border-white/8 bg-white/[0.03] rounded-2xl">
                  <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 mb-4">
                    ...
                    <div className="text-xs text-foreground/40 sm:text-right space-y-0.5 shrink-0">
                      <p className="font-medium text-foreground/55">
                        {exp.period}
                      </p>
