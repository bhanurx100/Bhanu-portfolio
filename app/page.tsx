...
export default function Home() {
  return (
    <main className="min-h-screen">
      ...
      {/* ── Tech stack badges ── */}
      <section
        className="py-10 border-y border-white/5 bg-transparent"
        aria-label="Technologies"
      >
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <p className="text-center text-white text-[13px] md:text-[14px] uppercase tracking-[0.4em] font-mono mb-6 md:mb-8">
            Technologies I work with
          </p>
          
          {/* Tightened row spacing (gap-2 on mobile, gap-3.5 on desktop) */}
          <div className="flex flex-wrap gap-2 md:gap-3.5 justify-center p-2 md:p-4">
            {[
              ...
              <span
                key={skill}
                className="
                  /* Size & Spacing (Scaled down to sit beautifully in fewer rows on mobile) */
                  px-3 py-1.5 md:px-5 md:py-2.5 rounded-lg md:rounded-xl 
                  text-[13px] md:text-[17px] font-medium tracking-wide
                  
                  /* Background & Base State */
                  bg-zinc-900/40 backdrop-blur-md
                  text-zinc-400
                  
                  /* Normal State Blue Ring */
